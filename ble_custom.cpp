...
BLECustomComponent* BLECustomComponent::instance_ = nullptr;
...
void BLECustomComponent::setup() {
    instance_ = this;
    ESP_LOGD("ble_custom", "Initializing BLE...");
    startble();
...
void BLECustomComponent::start_advertising_() {
}

void BLECustomComponent::loop() {
